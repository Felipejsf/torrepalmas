...
const floorPlans = {
  ...
  business: {
    ...
    rooms: [
      ...
      { id: 'A4', name: 'A4 · Gerencial', area: '34 m²', status: 'available', type: 'path', d: 'M46 281.209C68.46 281.349 90.92 281.489 113.38 281.619V263.719H153.3C153.44 269.549 153.58 275.379 153.71 281.209C176.33 281.349 198.95 281.489 221.57 281.619V332.399H46.38C46.25 315.329 46.13 298.269 46 281.199V281.209Z' },
